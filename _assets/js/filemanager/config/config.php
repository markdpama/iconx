...
$base_url="http://iconx.globetel.com";  // base url of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/_assets/images/articles/content/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../images/articles/content/'; // relative path from filemanager folder to upload folder (with final /)

//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../images/articles/content/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
