<div id="full-content">
	<div class="flip-full-content white_bg">
					...
					<div class="right_side">
						...
						<?php if($random_art) { ?>
							...
							<ul class="related" style="list-style:none;">
								...
								<li class="related_article_list" >
									<a href="<?php echo base_url(); ?>articles/get_article_full_flip/<?php echo $other_article['id']; ?>" class="ajax-popup-link">
